/*! leaflet.d3chart 0.1.3 2017-02-02
...
var e=c(a).toRgb(),f=c(b).toRgb(),g=d/100,h={r:(f.r-e.r)*g+e.r,g:(f.g-e.g)*g+e.g,b:(f.b-e.b)*g+e.b,a:(f.a-e.a)*g+e.a};return c(h)},c.readability=function(b,d){var e=c(b),f=c(d);return(a.max(e.getLuminance(),f.getLuminance())+.05)/(a.min(e.getLuminance(),f.getLuminance())+.05)},c.isReadable=function(a,b,d){var e,f,g=c.readability(a,b);switch(f=!1,e=M(d),e.level+e.size){case"AAsmall":case"AAAlarge":f=g>=4.5;break;case"AAlarge":f=g>=3;break;case"AAAsmall":f=g>=7}return f},c.mostReadable=function(a,b,d){var e,f,g,h,i=null,j=0;d=d||{},f=d.includeFallbackColors,g=d.level,h=d.size;for(var k=0;k<b.length;k++)e=c.readability(a,b[k]),e>j&&(j=e,i=c(b[k]));return c.isReadable(a,i,{level:g,size:h})||!f?i:(d.includeFallbackColors=!1,c.mostReadable(a,["#fff","#000"],d))};var U=c.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkgrey:"a9a9a9",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"f0f",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",grey:"808080",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgreen:"90ee90",lightgrey:"d3d3d3",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"789",lightslategrey:"789",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"0f0",limegreen:"32cd32",linen:"faf0e6",magenta:"f0f",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370db",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"db7093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"f00",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},V=c.hexNames=z(U),W=function(){var a="[-\\+]?\\d+%?",b="[-\\+]?\\d*\\.\\d+%?",c="(?:"+b+")|(?:"+a+")",d="[\\s|\\(]+("+c+")[,|\\s]+("+c+")[,|\\s]+("+c+")\\s*\\)?",e="[\\s|\\(]+("+c+")[,|\\s]+("+c+")[,|\\s]+("+c+")[,|\\s]+("+c+")\\s*\\)?";return{CSS_UNIT:new RegExp(c),rgb:new RegExp("rgb"+d),rgba:new RegExp("rgba"+e),hsl:new RegExp("hsl"+d),hsla:new RegExp("hsla"+e),hsv:new RegExp("hsv"+d),hsva:new RegExp("hsva"+e),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/}}();"undefined"!=typeof b&&b.exports?b.exports=c:"function"==typeof define&&define.amd?define(function(){return c}):window.tinycolor=c}(Math)},{}],3:[function(a,b,c){!function(){function b(a){return a.constructor!==Array&&(a=[a]),a}var c=a("d3"),d=a("tinycolor2"),e=a("./prettyNumbers.js");L.D3chart=L.CircleMarker.extend({options:{type:"bar",data:[1],maxValues:[1],fillColor:"#4281e5",colorPalette:c.schemeCategory10,width:60,height:60,opacity:1,showLabels:!1,labelStyle:"font-family:sans-serif",labelMinSize:8,labelMaxSize:24,labelPadding:2,labelColor:"auto",labelText:null,transitionTime:750},initialize:function(a,b){this._center=a,L.Util.setOptions(this,b),L.CircleMarker.prototype.initialize.call(this,a,{radius:this.options.width/2,stroke:!1,fill:!1})},onAdd:function(a){L.CircleMarker.prototype.onAdd.call(this,a);var b=this._container||this._renderer._container;b.setAttribute("class","leaflet-zoom-hide"),this._chart=c.select(b).append("g"),a.on("viewreset",this._redraw,this),this._redraw(!0)},onRemove:function(){L.CircleMarker.prototype.onRemove.call(this,map),map.off("viewreset",this._redraw,this)},setOptions:function(a){var b=a.type&&a.type!=this.options.type;L.Util.setOptions(this,a),this._redraw(b)},_redraw:function(a){a===!0&&this._chart.selectAll("*").remove();var c=this._map.latLngToLayerPoint(this._center);this.options.data=b(this.options.data),this.options.maxValues=b(this.options.maxValues);for(var d=this.options.maxValues,f=this.options.data,g=0;g<f.length;g++)!isNaN(f[g])&&isFinite(f[g])||(f[g]=0);if(1!==d.length&&d.length!=f.length)throw new Error("'maxValues' should be a single number or have same length as 'data'");dataScaled=[];for(var g=0;g<f.length;g++)dataScaled.push(f[g]/d[g%d.length]);if(this.options.showLabels){if(null==this.options.labelText)var h=e(f);else if(h=b(this.options.labelText),h.length!=f.length)throw new Error("Custom labels must have same length as data")}else var h=null;switch(this.options.type){case"bar":this._drawBar(c,dataScaled,a,h);break;case"pie":this._drawPolar(c,dataScaled,"angle",h);break;case"polar-radius":this._drawPolar(c,dataScaled,"radius",h);break;case"polar-area":this._drawPolar(c,dataScaled,"area",h)}},_drawBar:function(a,b,e,f){e?this._chart.append("line").attr("x1",-3).attr("x2",this.options.width+3).attr("style","stroke:#999;stroke-width:1;"):this._chart.select("line").attr("x1",-3).attr("x2",this.options.width+3);var g=c.scaleLinear().domain([0,1]).range([0,this.options.height]),h=1==b.length?[this.options.fillColor]:this.options.colorPalette,i=c.scaleOrdinal(h),j=this.options.width/b.length;this._chart.attr("transform","translate("+(a.x-this.options.width/2)+","+a.y+")").transition().duration(this.options.transitionTime).attr("opacity",this.options.opacity);var k=this._chart.selectAll("rect").data(b);if(k.enter().append("rect").attr("class","leaflet-clickable").attr("x",function(a,b){return(b+1)*j}).attr("y",function(a){return 0}).attr("width",0).merge(k).transition().duration(this.options.transitionTime).attr("width",j).attr("x",function(a,b){return b*j}).attr("y",function(a){return a>=0?-g(a):0}).attr("height",function(a){return Math.abs(g(a))}).attr("fill",function(a,b){return i(b)}),k.exit().transition().duration(this.options.transitionTime).attr("x",function(a,b){return b*j}).attr("y",0).attr("width",0).attr("height",0).remove(),f){var l;l="auto"==this.options.labelColor?function(a){return d.mostReadable(i(a),["white","black"])._originalInput}:function(a){return this.options.labelColor};var m=this.options.labelMinSize,n=this.options.labelMaxSize,o=this.options.labelPadding,p=this._chart.selectAll(".labels-container").data(b),q=this;p.enter().append("g").attr("class","labels-container").each(function(a,b){this._container=c.select(this),this._label=this._container.append("g").attr("class","label"),this._text=this._label.append("text").attr("class","leaflet-clickable").attr("dy","0.35em").attr("text-anchor","middle").attr("opacity",1).attr("style",q.options.labelStyle).attr("fill",l(b)).text(f[b]);var d=this._text.node().getBBox(),e=Math.min(n,Math.abs(g(a)))/d.height,h=(j-2*o)/d.width,i=Math.min(e,h);!isNaN(i)&&isFinite(i)||(i=0);var k=d.height*i;k<m&&(i=0);var p=a>0?k/2:-k/2;this._container.attr("transform","translate("+(b+.5)*j+","+(p-g(a))+")"),this._label.attr("transform","scale("+i+")")}).merge(p).each(function(a,b){this._text.text(f[b]);var c=this._text.node().getBBox(),d=Math.min(n,Math.abs(g(a)))/c.height,e=(j-2*o)/c.width,h=Math.min(d,e);!isNaN(h)&&isFinite(h)||(h=0);var i=c.height*h;i<m&&(h=0);var k=a>0?i/2:-i/2;this._posx=(b+.5)*j,this._posy=k-g(a),this._label.attr("transform","scale("+h+")")}).transition().duration(this.options.transitionTime).attr("transform",function(a,b){return"translate("+this._posx+","+this._posy+")"}),p.exit().remove()}else this._chart.selectAll("text").remove()},_drawPolar:function(a,b,e,f){function g(a){var b=c.interpolate(this._current,a);return this._current=b(0),function(a){return k(b(a))}}function h(a,c){if(b.length>1)return"translate("+k.centroid(a)+")";var d=this.getBBox(),e=d.height/d.width,f=Math.min(2*l(a.data)*Math.cos(Math.PI/2-Math.atan(e)),q),g=f/d.height;return this._height=f,"translate(0, 0) scale("+g+")"}this._chart.attr("transform","translate("+a.x+","+a.y+")").transition().duration(this.options.transitionTime).attr("opacity",this.options.opacity);var i=this.options.width/2,j=c.pie().sort(null),k=c.arc().innerRadius(0);if("angle"==e)j.value(function(a){return a}),k.outerRadius(function(a){return i});else{var l="radius"==e?c.scaleLinear():c.scalePow().exponent(.5);l.range([0,i]),j.value(function(a){return 1}),k.outerRadius(function(a,b){return l(a.data)})}var m=1==b.length?[this.options.fillColor]:this.options.colorPalette,n=c.scaleOrdinal(m),o=this._chart.selectAll("path").data(j(b));if(o.enter().append("path").attr("class","leaflet-clickable").attr("d",k).attr("fill",function(a,b){return n(b)}).each(function(a){1==b.length?this._current={startAngle:a.startAngle,endAngle:a.endAngle,data:0}:this._current={startAngle:a.endAngle,endAngle:a.endAngle}}).merge(o).transition().duration(this.options.transitionTime).attrTween("d",g).attr("fill",function(a,b){return n(b)}),o.exit().remove(),f){"auto"==this.options.labelColor?labelColor=function(a,b){return d.mostReadable(n(b),["white","black"])._originalInput}:labelColor=this.options.labelColor;var p=this.options.labelMinSize,q=this.options.labelMaxSize,r=this._chart.selectAll("text").data(j(b));r.enter().append("text").attr("class","leaflet-clickable").text(function(a,b){return f[b]}).attr("text-anchor","middle").attr("dy","0.35em").attr("opacity",0).attr("transform",h).attr("style",this.options.labelStyle).attr("fill",labelColor).merge(r).text(function(a,b){return f[b]}).transition().duration(this.options.transitionTime).attr("fill",labelColor).attr("transform",h).attr("opacity",function(){return this._height<p?0:1}),r.exit().remove()}else this._chart.selectAll("text").remove()}}),L.d3chart=function(a,b){return new L.D3chart(a,b)}}()},{"./prettyNumbers.js":4,d3:1,tinycolor2:2}],4:[function(a,b,c){function d(a){if(isNaN(a)||!isFinite(a))return"";var b=Math.abs(a),c=a<0?"-":"";return b<1e3?scale="":b<1e6?(scale="K",b/=1e3):b<1e9?(scale="M",b/=1e6):b<1e12?(scale="B",b/=1e9):b<1e15&&(scale="T",b/=1e12),b=b>10?e(b):b>1?e(b,10,!0):e(b,100,!0),c+b+scale}function e(a,b,c){return b=b||1,c?Math.round(a*b)/b:Math.round(a/b)*b}b.exports=function(a){return a.map(d)}},{}]},{},[3]);